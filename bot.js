...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'OpenWorld2.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 52808,                // Puerto predeterminado de Minecraft
        username: 'maxi_boot',    // Nombre genérico del bot/NPC dentro del juego
